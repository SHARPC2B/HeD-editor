...
//        System.out.println( dir.getAbsolutePath() );
    ...
    public void processExample() throws Exception {
        ...
        Object o = em.find( ProductionRuleSetImpl.class, URI.create( "http://asu.edu/sharpc2b/example1#ruleSet1" ) );
        ...
        OutputStream outStream = new FileOutputStream( new File( dir.getAbsolutePath() + File.separator + "example1.obj.gson" ) );
    ...
    private com.tinkerpop.blueprints.Graph asObjectGraph( Thing o ) {
        ...
        Graph blueGraph = (Graph) new AbstractObjectGraphVisitor() {
            ...
            @Override
            protected void visitRelationEdge( org.drools.semantics.Thing node, String prop, Object tgt ) {
                if ( blueGraph.getVertex( tgt ) == null ) {
                    blueGraph.addVertex( tgt );
                }
                blueGraph.addEdge( UUID.randomUUID(), blueGraph.getVertex( node.getRdfId() ), blueGraph.getVertex( tgt ), prop );
            ...
            @Override
            protected void visitTypeEdge( org.drools.semantics.Thing node, URI tgt ) {
        ...
        System.err.println( " DUMPING AS OBJECT GRAPH : time elapsed >> " + ( System.currentTimeMillis() - now ) );
    ...
    private com.tinkerpop.blueprints.Graph asPropertyGraph(OWLOntology onto) {
        ...
        AbstractTranslator tinker = new AbstractTranslator( onto.getOWLOntologyManager(), onto, false ) {
            ...
            protected void addTriple(Object subject, Object pred, Object object) {
                ...
                blueGraph.addEdge( UUID.randomUUID(), src, tgt, ((org.openrdf.model.URI) pred).getLocalName() );
